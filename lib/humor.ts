...
export function tagesAnweisung(letzteSaetze: string[], letztePremissen: Premisse[]): string {
  const teile = [
    ...
    'Bei den Bildern steht, wer darauf markiert ist. Ist die sprechende Katze',
    'nicht dabei, redet sie über die andere – nicht in der Ich-Form über eine',
    'Szene, in der sie nicht vorkommt.',
    '',
