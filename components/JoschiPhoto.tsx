...
export default function JoschiPhoto({ size = 80 }: { size?: number }) {
  ...
  return (
    <>
      <button
        ...
        className="relative rounded-full overflow-hidden border-4 border-white/60 shadow-lg flex-shrink-0 cursor-zoom-in"
